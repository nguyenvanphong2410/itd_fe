...
import { requestGetAllDocumentOfNameAdmin } from "../../../../../api/documents";
...
import PaginationOther from "./components/pagination/paginationOther";
import InputSearchOther from "./components/inputSearch/inputSearchOther";
...
const UserOther = () => {
  ...
  const hanleClickTitleHeading = () => {
    dispatch(setDataFilterOther({ ...filter, search: null }))
    dispatch(requestGetAllOther())
  }
  ...
  return (
    <>
        ...
        <div className={styles.headingWrapper}>
          <div className={styles.headingTitle}>
            ...
            <span className={styles.title}>
              <p className={styles.titleLink} to="/users" onClick={hanleClickTitleHeading}>Thông tin người dùng khác</p>
            </span>
          </div>

          <div className={styles.headingOpption}>

            <InputSearchOther usersList={others} />
          </div>
        </div>
            ...
            <tbody>
              {
                listOfficer?.map((userData, index) => (
                  <tr key={userData._id}>
                    ...
                    <td data-label="Vai trò"> <span> <Tag color="green">Người dùng</Tag></span> </td>
      ...
      <PaginationOther usersList={others} />
